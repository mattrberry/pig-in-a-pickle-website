<template>
  <div class="menu">
    ...
    <LocationSwitcher>
      ...
      <div slot="Emeryville">
        <h1>Online ordering not yet available in Emeryville</h1>
        <div class="blocks">
    ...
    <div class="vendor-logo-container" v-for="vendor in vendors" v-bind:key="vendor.name">
